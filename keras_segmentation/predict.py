...
def evaluate(model=None, inp_images=None, annotations=None,
    ...
    median_iou_per_class = {}
    for cl_i, iou_value in iou_per_class_per_image.items():
        median_iou_per_class[cl_i] = np.median(iou_value)
    	    
    wandb.log({"tp":tp, "fp":fp, "fn":fn, 
    "iou_per_class_per_image":iou_per_class_per_image,"class_wise_median_IU": median_iou_per_class})
